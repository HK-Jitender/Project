// // module.exports = class Orderandorderitemupdate1744179515117 {
// //     name = 'Orderandorderitemupdate1744179515117'

// //     async up(queryRunner) {
// //         await queryRunner.query(`CREATE TABLE \`orders\` (\`id\` int NOT NULL AUTO_INCREMENT, \`customerId\` int NOT NULL, \`total\` decimal NOT NULL, \`status\` varchar(255) ('Order confirmed', 'Picking', 'Checking out', 'Delivered', 'Cancel') NOT NULL, \`delivery\` varchar(255) NOT NULL, \`paymentMethod\` varchar(255) NOT NULL, \`createdAt\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, \`updatedAt\` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
// //         await queryRunner.query(`CREATE TABLE \`order_items\` (\`id\` int NOT NULL AUTO_INCREMENT, \`productId\` int NOT NULL, \`quantity\` int NOT NULL, \`price\` decimal NOT NULL, \`orderId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
// //         await queryRunner.query(`CREATE TABLE \`order_summaries\` (\`id\` int NOT NULL AUTO_INCREMENT, \`subtotal\` decimal NOT NULL, \`serviceFee\` decimal NOT NULL, \`overWeightFee\` decimal NOT NULL, \`orderId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
...
// //         await queryRunner.query(`ALTER TABLE \`order_summaries\` ADD CONSTRAINT \`FK_d84f0768767ccb1d9517cf88a49\` FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`);
...
// //         await queryRunner.query(`ALTER TABLE \`order_summaries\` DROP FOREIGN KEY \`FK_d84f0768767ccb1d9517cf88a49\``);
...
// //     }
// // }
// export default class Orderandorderitemupdate1744179515117 {
//     name = 'Orderandorderitemupdate1744179515117'
...
//                 \`status\` ENUM('Order confirmed', 'Picking', 'Checking out', 'Delivered', 'Cancel') NOT NULL,
...
//         // Create the 'order_summaries' table
//         await queryRunner.query(`
...
//         // Add foreign key constraints to 'orders' and 'order_items' tables
//         await queryRunner.query(`
//             ALTER TABLE \`orders\`
...
//             ADD CONSTRAINT \`FK_d84f0768767ccb1d9517cf88a49\`
//             FOREIGN KEY (\`orderId\`) REFERENCES \`orders\`(\`id\`)
//             ON DELETE NO ACTION ON UPDATE NO ACTION
//         `);
//     }
...
//         // Drop the 'order_items', 'order_summaries', and 'orders' tables
//         await queryRunner.query(`DROP TABLE \`order_summaries\``);
//         await queryRunner.query(`DROP TABLE \`order_items\``);
//         await queryRunner.query(`DROP TABLE \`orders\``);
//     }
