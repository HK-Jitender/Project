export default  class CreateInitialTables1743765328766 {
    name = 'CreateInitialTables1743765328766'

    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE \`tokens\` (\`id\` int NOT NULL, \`token\` varchar(255) NOT NULL, \`type\` varchar(255) NOT NULL, \`expires\` timestamp NOT NULL, \`blacklisted\` tinyint NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
