...
import moment from 'moment'; // Use import instead of require
import config from '../config/config.js'; // Ensure to include .js extension
...
import RedisService from './RedisService.js'; // Ensure to include .js extension
...
export default TokenService; // Keep the export as is
